...
normalize_dist <- function(dist) {
  dist_map <- c(normal = 'norm', norm = 'norm', lnorm = 'lnorm', lnormal = 'lnorm',
                ...
                pnorm = 'pnorm', powernormal = 'pnorm', power_normal = 'pnorm',
                'power normal' = 'pnorm')
  key <- tolower(dist)
...
#'   integrate optim glm binomial pt residuals model.matrix setNames
#' @importFrom powdist dpnorm ppnorm qpnorm
NULL
